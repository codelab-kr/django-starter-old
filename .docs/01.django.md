...
bm in python-wsgi/django-01/django_starter
```
...
# 가상환경 경로 확인
➜  pipenv --venv
/Users/bm/.local/share/virtualenvs/django_starter-RSO5XgiL
```
...
> 파이썬 인터프리터 경로 설정 \
/Users/bm/.local/share/virtualenvs/django_starter-RSO5XgiL/bin/python
...
```
## /django_starter/sattiings.py 에 app 등록
```python
INSTALLED_APPS = [
    ...
    'posts',
...
## /django_starter/urls.py 에 app url 등록
```python
from . import views
